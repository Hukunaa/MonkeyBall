...
namespace Voodoo.Sauce.Internal
{
    public static class VoodooLog
    {
        ...
        private const string PRODUCTTAG = "TinySauce";
        private const string TAG = "VoodooLog";
        ...
        private static string Format(string tag, string message) => $"{DateTime.Now} - {PRODUCTTAG}/{tag}: {message}";
