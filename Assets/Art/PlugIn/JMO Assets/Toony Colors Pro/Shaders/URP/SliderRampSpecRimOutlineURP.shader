...
Shader "Voodoo/GameOps/SliderRampSpecRimOutlineURP"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				//MatCap
				#if defined(TCP2_MATCAP)
				fixed3 matcap = tex2D(_MatCapTex, input.pack0.zw).rgb * __matcapColor;
				emission += matcap;
				#endif
